          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
                <div class="ftco-media-1">
                  <div class="ftco-media-1-inner">
                    <a class="d-inline-block mb-4"><?php echo anchor('dashboard/detail/'.$huni->id_hunian,'<div type="hidden"></div') ?><img src="<?php echo base_url().'/uploads/'.$huni->gambar ?>" class="img-fluid"></a>
                    <div></div></div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-3 text-black">Panduan</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 text-center">
            <div class="pr-5 first-step">
              ...
              <h3 class="text-black">Temukan Hunian.</h3>
              <p class="text-black">Disini anda dapat menemukan properti yang siap untuk anda sewa.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 text-center">
            <div class="pr-5 second-step">
              ...
              <h3 class="text-dark">Iklankan Properti Anda</h3>
              <p class="text-black">Jika anda memiliki properti untuk disewakan anda dapat mengiklankan disini.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 text-center">
            <div class="pr-5">
              ...
              <h3 class="text-dark">Hubungi Pemilik Hunian</h3>
              <p class="text-black">Jika anda tertarik dengan properti yang disewakan silahkan hubungi penjual dan lakukan transaksi secara pribadi.</p>
            </div>
          </div>
        </div>
      </div>  
