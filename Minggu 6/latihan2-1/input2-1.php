<html>
<head>
	<title> latihan 2-1 (input) </title>
</head>
<body>
<table align="center" border="1">
	<form method="post" action="proses2-1.php">
...
<tr>
	...
	<p><input type="checkbox" name="catatan_khusus[]" value="Interaktif dikelas">Interaktif di kelas</p>
